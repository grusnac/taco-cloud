...
public class DesignAndOrderTacosBrowserTest {
    ...
    @Test
    void shouldDesignATaco_HappyPath() {
    ...
    @Test
    public void shouldNotDesignATaco_UnhappyPath_EmptyOrderInformation() throws Exception {
        browser.get(homePageUrl());
        clickDesignATaco();
        assertDesignPageElements();
        buildAndSubmitATaco("Basic Taco", "FLTO", "GRBF", "CHED", "TMTO", "SLSA");
    ...
    @Test
    public void shouldNotDesignATaco_UnhappyPath_InvalidOrderInformation() throws Exception {
        browser.get(homePageUrl());
        clickDesignATaco();
        assertDesignPageElements();
        buildAndSubmitATaco("Basic Taco", "FLTO", "GRBF", "CHED", "TMTO", "SLSA");
    ...
    private List<String> getValidationErrorTexts() {
        List<WebElement> validationErrorElements = browser.findElementsByClassName("validation-error");
    ...
    private void clickOnDesignATaco() {
        assertEquals(homePageUrl(), browser.getCurrentUrl());
